...
<body>
    ...
    <div class="app-header">
        ...
        <div class="header-stats">
            ...
            <a href="index.html" style="background: linear-gradient(135deg, #0284c7, #2563eb); border: 1px solid #38bdf8; border-radius: 8px; padding: 8px 14px; text-decoration: none; display: flex; flex-direction: column; justify-content: center; align-items: center; box-shadow: 0 0 12px rgba(56,189,248,0.35); cursor: pointer;" title="进入包含天猫大盘前300款与公司95款的全域全量对比大屏">
                <div style="font-size: 13px; font-weight: 700; color: #fff; display: flex; align-items: center; gap: 4px;">⚖️ 跨库全域对比大屏 ↗</div>
                <div style="font-size: 11px; color: #bae6fd;">市场300款 + 公司95款</div>
            </a>
        </div>
    </div>
